...
const Index = () => {
  ...
  return (
    <div className="flex flex-col relative space-y-[7vh] mb-[5vh] mt-[10vh]">
      {/* <div className="flex flex-col relative space-y-[12vh] mb-[10vh] bg-diagonal-fade bg-blend-lighten "> */}
          ...
          <div className="flex w-screen justify-center">
            <div className="w-[90vw] bg-rouge flex justify-between items-center py-24 px-16 rounded-xl">
              <div className="relative bg-opacity-40 rounded-xl w-[34vw] h-[32vh] ml-10">
                ...
                {/* Image produit */}
                <div className="absolute right-0 top-0 transform w-[42%] rounded-xl">
                  <img
                    src={BlobImage.src}
              ...
              <div className="w-[35vw] flex flex-col space-y-5">
                <span className={`${inter.className} text-[40px] text-black`}>
                  Qui sommes-nous ?
                </span>
                <span className={`${inter.className} text-[15px] text-black`}>
          ...
          <div className="flex w-screen justify-center">
            <div className="w-[87vw] bg-black flex justify-between items-center text-white py-24 px-16 rounded-xl">
              <div className="w-[33vw] flex flex-col space-y-4 ">
                <span className={`${lato.className} text-[40px] text-white`}>
                  Réserver en toute simplicité
                </span>
                <span className={`${inter.className} text-[15px] text-white text-opacity-85`}>
