  ...
  return (
    <div className="flex relative px-[10vw] mt-20">
      ...
      <div className="relative w-[58%] h-full mr-5">
          <div
            ref={divRef}
            className="absolute flex items-center space-x-8 z-20 -top-6 left-0 w-[60%] bg-white rounded-lg p-6 shadow-2xl filter brightness-[65%]"
          >
          ...
          <div
            ref={div2Ref}
            className="absolute flex items-center space-x-8 z-30 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[55%] bg-white rounded-lg py-6 px-6 shadow-2xl filter brightness-100"
          >
          ...
          <div
            ref={div3Ref}
            className="absolute flex items-center space-x-8 z-20 -bottom-5 -right-5 w-[70%] bg-white rounded-lg p-6 shadow-2xl filter brightness-[65%]"
          >
        ...
        <div className="w-[32%] flex flex-col space-y-4 ">
          <span className={`${mont_bold.className} text-[35px] text-noir/80`}>
