...
const Index = () => {
  return (
    <div className="flex w-screen justify-center mt-28 mb-36">
      <div className="w-[80vw]  bg-grisbeige/60 rounded-xl flex px-12 py-16 justify-between shadow-sm">
        ...
        <div className="w-[56%] flex flex-col justify-center">
          <span className={`${mont_bold.className} text-noir/90 text-[24px] mb-2`}>Vous êtes praticien ?</span>
          <span className={`${mont_semi.className} text-noir/70 mb-6`}>Wicca, logiciel de gestion dédié au professionnels de l’ésoterisme.</span>

          <div className={`${mont.className} text-noir/60 mb-2 flex flex-col text-[15px]`}>
          ...
          <button className={`${mont_semi.className} uppercase text-[14px] bg-white shadow-sm px-4 py-2 w-auto self-start rounded-lg mt-8 text-maincolor`}>Devenir praticien avec wicca </button>
        </div>
      </div>
